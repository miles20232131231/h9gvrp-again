...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const targetChannel = await interaction.client.channels.fetch('1231926281113829486');
            ...
            const confirmationEmbed = new EmbedBuilder()
                .setDescription(`A new vehicle has been registered by <@${interaction.user.id}>. Please navigate to <#1231926281113829486> to view the registration details.`);

            const confirmationChannel = await interaction.client.channels.fetch('1268950476477698068');
